...
<main class="main">
  <div class="container">
    <header class="col-lg-12 stories-header"><?php $hl; // this is for the copy issues. Instead dealing with the buttons and the like, this just lookes up the title name then output for it.  ?><?php if(get_the_title() ==  "Wellness" ): ?><?php $hl ='Real tips, tools, and stories to help when <strong>Quitting for your Wellness</strong>'; ?><?php elseif(get_the_title() ==  "Illness" ):  ?><?php $hl ='Real tips, tools, and stories to help when <strong>Quitting for your Illness</strong>'; ?><?php elseif(get_the_title() ==   "Baby"): ?><?php $hl ='Real tips, tools, and stories to help when <strong>Quitting for your Baby</strong>'; ?><?php elseif(get_the_title() ==   "Family"): ?><?php $hl ='Real tips, tools, and stories to help when <strong>Quitting for your Family</strong>'; ?><?php elseif(get_the_title() ==   "Loss"): ?><?php $hl ='Real tips, tools, and stories to help when <strong>Quitting for your Lost Loved One</strong>'; ?><?php else: ?><?php $hl ='Real tips, tools, and stories to help when <strong>Quitting to save Money</strong>'; ?><?php endif; ?>
    </header>
  ...
  <div class="container"><?php $quotes = get_field('quote_picker');  ?><?php if($quotes):  ?>
