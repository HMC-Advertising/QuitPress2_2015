<?php $real_stories = get_ID_by_slug('real-stories'); ?><?php $icon_list = new page_list_with_icons(); ?><?php $mobile_Icons = new page_list_with_icons_Mobile(); ?><?php if(is_mobile()): ?><i style="position: absolute;top: 130px;left: 4px;font-size: 81px; color:#0DBDEE; z-index:100000000" class="fa fa-caret-left"></i>
...
</div><i style="position: absolute;top: 130px; right: 4px; font-size: 81px; color:#0DBDEE; z-index:100000000" class="fa fa-caret-right"></i><?php else : ?>
