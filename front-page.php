...
<div class="grid">
  <div class="tgrid-1-2 ta-center welcome-text">
    <h2>See Real Stories From Around<span class="hidden-lg hidden-xs hidden-sm hidden-xxs"<br></span> the 802</h2><?php if(is_ipad() or is_tablet()):  // and !is_ipad() and !is_tablet() ?> ?>
