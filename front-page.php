...
<div class="container">
  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ta-center welcome-text">
    ...
    <h3 class="<?php if(is_ipad() or is_tablet()){echo 'M';} ?>"><strong> You're not alone. </strong> Vermonters share their stories, tips and tools to help you quit. Their experiences can help you quit. </h3><?php if(is_mobile() ): //or is_ipad() or is_tablet()  ?>
